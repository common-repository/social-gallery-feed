...
class SI_Admin
{
    ...
    protected $plugin_slug = 'insta-feed-widget';
    ...
    public function add_plugin_admin_menu() {
        ...
        $this->plugin_screen_hook_suffix = add_options_page( __( 'Insta Feed Widget Settings', $this->plugin_slug ), __( 'Insta Feed Widget', $this->plugin_slug ), 'manage_options', $this->plugin_slug, array( $this, 'display_plugin_admin_page' ) );
    }
    ...
    public function si_authorize_notice() {
        ...
        if ( 'settings_page_insta-feed-widget' == $screen->id ) {
            return;
        }
        ...
        <div class="error">
            <p><?php _e( sprintf( "<b>Insta Feed Widget:</b> You'll need to %s before your Instagram feeds will display.", '<a href="' . esc_url( admin_url( 'options-general.php?page=insta-feed-widget' ) ) . '">authorize your account</a>' ), 'insta-feed-widget' ); ?></p>
        </div>
